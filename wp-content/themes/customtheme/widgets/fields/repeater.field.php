...
class widget_field_repeater {
    ...
    public function render( $field_args = [] ) 
    {
        ...
        if ( isset ( $field_args['title'] ) ) {
            ...
            $widget_title = __( 'Repeater', 'custom' );
        }
        ...
        $output .= '<div class="widget-items render-field box-field-repeater repeaters">';
        ...
        $output .= '<span>'.__( 'rowCloneindex', 'custom' ).'</span>';
        $output .= '</div>';
        ...
        foreach ( $field_args['fields'] as $key => $item ) {
            ...
            if ( $item['type'] == 'text' ) {
                ...
                if ( isset ( $item['title'] ) ) {
                    ...
                    $item_title = __( 'Văn bản ngắn', 'custom' );
                }

                if ( isset ( $item['class'] ) ) {
                    $class = 'class="custom-widget ref-field-text '.esc_attr( $item['class'] ).'"';
                } else {
                ...
                if ( isset ( $item['title'] ) ) {
                    ...
                    $item_title = __( 'Văn bản dài', 'custom' );
                }

                if ( isset ( $item['class'] ) ) {
                    $class = 'class="custom-widget ref-field-textarea '.esc_attr( $item['class'] ).'"';
                } else {
                    $class = 'class="custom-widget ref-field-textarea"';
                }
                ...
                if ( isset ( $item['title'] ) ) {
                    ...
                    $item_title = __( 'Hình ảnh', 'custom' );
                }

                if ( isset ( $item['class'] ) ) {
                    $class = 'class="custom-widget ref-field-image '.esc_attr( $item['class'] ).'"';
                } else {
                ...
                if ( isset ( $item['title'] ) ) {
                    ...
                    $item_title = __( 'Select', 'custom' );
                }

                if ( isset ( $item['class'] ) ) {
                    $class = 'class="custom-widget ref-field-select '.esc_attr( $item['class'] ).'"';
                } else {
                ...
                if ( isset ( $item['title'] ) ) {
                    ...
                    $item_title = __( 'Radio', 'custom' );
                }

                if ( isset ( $item['class'] ) ) {
                    $class = 'class="custom-widget ref-field-radio '.esc_attr( $item['class'] ).'"';
                } else {
                    $class = 'class="custom-widget ref-field-radio"';
                }
                ...
                if ( isset ( $item['title'] ) ) {
                    ...
                    $item_title = __( 'Checkbox', 'custom' );
                }

                if ( isset ( $item['class'] ) ) {
                    $class = 'class="custom-widget ref-field-checkbox '.esc_attr( $item['class'] ).'"';
                } else {
                    $class = 'class="custom-widget ref-field-checkbox"';
                }
                ...
                if ( isset ( $item['title'] ) ) {
                    ...
                    $item_title = __( 'Gallery', 'custom' );
                }

                if ( isset ( $item['class'] ) ) {
                    $gallery_class = 'class="custom-widget ref-field-gallery '.esc_attr( $item['class'] ).'"';
                } else {
                    $gallery_class = 'class="custom-widget ref-field-gallery"';
                }
                ...
                $output .= '<button class="upload_gallery_button button button-primary">'.__( 'Chọn ảnh', 'custom' ).'</button>';
                $output .= '</div>';
                $output .= '</div>';
                $output .= '<script>
        ...
        $output .= '<button class="remove_row_button button button-danger">'.__( 'Xóa dòng', 'custom' ).'</button>';
        $output .= '</div>';
        $output .= '</div>';
        $output .= '</div>';
        /**
                    ...
                    foreach ( $field_args['fields'] as $k => $field ) {
                        ...
                        if ( $field_args['fields'][$k]['type'] == 'text' ) {
                            ...
                            if ( isset ( $field_args['fields'][$k]['class'] ) ) {
                                $class = 'class="custom-widget ref-field-text '.$field_args['fields'][$k]['class'].'"';
                            } else {
                                $class = 'class="custom-widget ref-field-text"';
                            }
                            ...
                            if ( isset ( $field_args['fields'][$k]['class'] ) ) {
                                $class = 'class="custom-widget ref-field-textarea '.$field_args['fields'][$k]['class'].'"';
                            } else {
                                $class = 'class="custom-widget ref-field-textarea"';
                            }
                            ...
                            if ( isset ( $field_args['fields'][$k]['class'] ) ) {
                                $class = 'class="custom-widget ref-field-image '.$field_args['fields'][$k]['class'].'"';
                            } else {
                                $class = 'class="custom-widget ref-field-image"';
                            }
                            ...
                            if ( isset ( $field_args['fields'][$k]['class'] ) ) {
                                $class = 'class="custom-widget ref-field-select '.$field_args['fields'][$k]['class'].'"';
                            } else {
                                $class = 'class="custom-widget ref-field-select"';
                            }
                            ...
                            if ( isset ( $field_args['fields'][$k]['class'] ) ) {
                                $class = 'class="custom-widget ref-field-radio '.$field_args['fields'][$k]['class'].'"';
                            } else {
                                $class = 'class="custom-widget ref-field-radio"';
                            }
                            ...
                            if ( isset ( $field_args['fields'][$k]['class'] ) ) {
                                $class = 'class="custom-widget ref-field-checkbox '.$field_args['fields'][$k]['class'].'"';
                            } else {
                                $class = 'class="custom-widget ref-field-checkbox"';
                            }
                            ...
                            if ( ! empty ( $field_args['fields'][$k]['type']['class'] ) ) {
                                $gallery_class = 'custom-widget ref-field-gallery '.$field_args['fields'][$k]['type']['class'].'';
                            } else {
                                $gallery_class = 'custom-widget ref-field-gallery';
                            }
                            ...
                            if ( ! empty ( $field_args['value'][$key][$k] ) ) {
                                ...
                                foreach ( $field_args['value'][$key][$k] as $gallery => $value ) {
                                    ...
                                    $output .= '<a href="javascript:;" class="act-remove-image">'.__( 'Xóa', 'custom' ).'</a>';
                                    $output .= '</div>';
                                    $output .= '</div>';
                                    $output .= '</div>';
                                    $image_stt++;
        ...
        $output .= '<button class="add_row_button button button-primary ali-bt">'.__( 'Thêm dòng', 'custom' ).'</button>';
        // if ( isset ( $row ) && $row >= 2 ) {
        //     $output .= '<a href="javascript:;" class="order_field_button button button-primary ali-bt">'.__( 'Sắp sếp', 'custom' ).'</a>';
        // }
        $output .= '<script>
        jQuery(document).ready(function($) {
