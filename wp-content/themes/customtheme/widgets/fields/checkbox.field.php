...
class widget_field_checkbox {
    ...
    public function render( $field_args = [] ) {
        ...
        if ( isset ( $field_args['title'] ) ) {
            ...
            $widget_title = __( 'Checkbox', 'custom' );
        }
        ...
        if ( isset ( $field_args['class'] ) ) {
            $class = 'class="custom-widget ref-field-checkbox '.$field_args['class'].'"';
        } else {
        ...
        $output .= '<div class="widget-items render-field box-field-checkbox">';
