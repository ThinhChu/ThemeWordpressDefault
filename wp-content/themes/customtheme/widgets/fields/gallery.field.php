...
class widget_field_gallery {
    ...
    public function render( $field_args = [] ) 
    {
        ...
        if ( isset ( $field_args['title'] ) ) {
            ...
            $widget_title = __( 'Gallery', 'custom' );
        }
        ...
        if ( isset ( $field_args['class'] ) ) {
            $class = 'custom-widget ref-field-gallery '.esc_attr( $field_args['class'] ).'';
        } else {
            $class = 'custom-widget ref-field-gallery';
        }
        ...
        $output .= '<div class="widget-items render-field box-field-gallery">';
