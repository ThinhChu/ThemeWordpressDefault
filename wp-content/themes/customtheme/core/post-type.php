    ...
    function custom_regsiter_custom_post_types() {
        ...
        $posttype_course = [
            'labels' => [
                ...
                'all_items'     => __( 'Tất cả bài viết', 'custom' ),
                'add_new'       => __( 'Viết bài mới', 'custom' ),
                'add_new_item'  => __( 'Bài viết mới', 'custom' ),
                'edit_item'     => __( 'Chỉnh sửa bài viết', 'custom' ),
                'new_item'      => __( 'Thêm bài viết', 'custom' ),
                'view_item'     => __( 'Xem bài viết', 'custom' ),
                'view_items'    => __( 'Xem bài viết', 'custom' ),
            ],
