...
class Setup_Theme {
    ...
    public function __construct() 
    {
        ...
        add_filter( 'wp_head', [ $this, 'custom_remove_wp_widget_recent_comments_style' ], 1 );
        add_action( 'wp_head', [ $this, 'custom_remove_recent_comments_style' ], 1 );
        add_filter( 'the_content', [ $this, 'custom_filter_ptags_on_images' ] );
        ...
        add_filter( 'wp_nav_menu_objects', [ $this, 'custom_add_menu_parent_class' ] );
    ...
    public function after_setup_theme() 
    {
        ...
        load_theme_textdomain( 'custommedia' , get_template_directory() . '/languages' );
     ...
     * @return void
     */
    public function custom_rss_version() 
    {
        return '';
    }
     ...
     * @return void
     */
    public function custom_remove_wp_widget_recent_comments_style() 
    {
     ...
     * @return void
     */
    public function custom_remove_recent_comments_style() 
    {
     ...
     * @return void
     */
    public function custom_filter_ptags_on_images($content) 
    {
    ...
    {
        if (isset($_GET['custom-support-param'])) {
            $id = intval(@$_GET['custom-support-param']);
            if ($id == 0) {
     ...
     * @return void
     */
    public function custom_add_menu_parent_class( $items ) 
    {
        $parents = array();
